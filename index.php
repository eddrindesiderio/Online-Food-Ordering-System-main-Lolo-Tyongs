...
<html lang="en">
  ...
  <!-- <div class="site-wrap"> -->
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2 site-logo">
            <h1 class="mb-0"><a href="index.php" class="text-white h2 mb-0">LoloTyong's</a></h1>
          </div>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(meyn/12.png);" data-aos="fade" data-stellar-background-ratio="0.5" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold" data-aos="fade-up">Lolo Tyong's Lechon</h1>
    ...
    <div class="site-section border-bottom" id="section-our-team">
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            <h2 class="font-weight-light text-primary" data-aos="fade">Team Zheck &#9824;</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person">
              <img src="meyn/51.jpg" alt="Image" class="img-fluid rounded mb-5 w-75 rounded-circle">
              <h3>Gelyn</h3>
              <p class="position text-muted">Role: Support</p>
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="person">
              <img src="meyn/7.png" alt="Image" class="img-fluid rounded mb-5 w-75 rounded-circle">
              <h3>Zhenkiy</h3>
              <p class="position text-muted">Role: Main</p>
              <ul class="ul-social-circle">
                <li><a href="#"><span class="icon-facebook"></span></a></li>
                <li><a href="#"><span class="icon-twitter"></span></a></li>
                <li><a href="#"><span class="icon-linkedin"></span></a></li>
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="person">
              <img src="meyn/3.jpg" alt="Image" class="img-fluid rounded mb-5 w-75 rounded-circle">
              <h3>Luffy</h3>
              <p class="position text-muted">Role: Support</p>
              <ul class="ul-social-circle">
                <li><a href="#"><span class="icon-facebook"></span></a></li>
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="person">
              <img src="meyn/4.jpg" alt="Image" class="img-fluid rounded mb-5 w-75 rounded-circle">
              <h3>Kaneki</h3>
              <p class="position text-muted">Role: Support</p>
              <ul class="ul-social-circle">
                <li><a href="#"><span class="icon-facebook"></span></a></li>
